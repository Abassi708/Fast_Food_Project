...
Public Class Form1
    ...
    Private Sub Numbers_Only(sender As Object, e As KeyPressEventArgs) Handles txtSalad.KeyPress, txtOnionRings.KeyPress, txtHamburger.KeyPress, txtFries.KeyPress, txtFishSandwich.KeyPress, txtChikenSandwich.KeyPress, txtChikenSalad.KeyPress, txtCheeseSandwich.KeyPress, txtToasted.KeyPress, txtPineapple.KeyPress, txtPancakes.KeyPress, txtMuffin.KeyPress, txtHash.KeyPress, txtWater.KeyPress, txtTea.KeyPress, txtCola.KeyPress, txtCoffee.KeyPress, txtStrawberry.KeyPress, txtShake.KeyPress, txtMilkShake.KeyPress, txtCone.KeyPress, chkChocolateMilkShake.KeyPress, txtPayementMethod.KeyPress
